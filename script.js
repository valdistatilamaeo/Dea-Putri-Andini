...
const translations = {
    id: {
        ...
        about_full_summary: "Lulusan Sarjana Manajemen Operasi dengan pengalaman dalam administrasi keuangan, data karyawan, produksi garmen, QC, dan risiko operasional. Terampil dalam administrasi, pelaporan, analisis data, Operasi & Rantai Pasok, serta evaluasi proses. Saat ini sedang memperdalam Manajemen Keuangan, Analisis Data, dan Manajemen SDM, dengan minat karir di bidang Keuangan, SDM, Operasi & Rantai Pasok, Produksi, dan Quality Control. Komunikatif, teliti, adaptif, dan kolaboratif.",
    ...
    en: {
        ...
        about_full_summary: "Bachelor’s graduate in Operations Management with experience in financial administration, employee data, garment production, QC, and operational risk. Skilled in administration, reporting, data analysis, Operations & Supply Chain, and process evaluation. Currently strengthening Financial Management, Data Analysis, and HR Management, with career interests in Finance, HR, Operations & Supply Chain, Production, and Quality Control. Communicative, detail-oriented, adaptable, and collaborative.",
